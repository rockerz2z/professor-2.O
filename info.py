...
auth_channel = environ.get('AUTH_CHANNEL', '-1001660466640') # give your force subscribe channel id here else leave it blank
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Rockers001")
